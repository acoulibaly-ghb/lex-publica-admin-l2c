...
const VoiceChat: React.FC = () => {
  ...
  return (
    <div className="h-full flex items-center justify-center p-4 bg-[#0B1120] transition-colors duration-300">
     <div className="w-full max-w-5xl h-full max-h-[95%] bg-slate-900 rounded-3xl overflow-hidden relative shadow-2xl ring-1 ring-white/10 flex flex-col">
      {/* Animated Background */}
      ...
      {/* Controls */}
      <div className="p-6 z-20 flex justify-center items-center bg-slate-900/50 border-t border-slate-800 backdrop-blur-sm">
        {!isConnected ? (
          <button
