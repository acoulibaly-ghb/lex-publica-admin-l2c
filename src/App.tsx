        ...
        <header className="mb-10 text-center space-y-4">
          ...
          <div>
            ...
            <p className="text-lg text-slate-600 max-w-2xl mx-auto leading-relaxed">
              Votre assistante virtuelle experte en droit administratif général.
              <span className="block text-sm text-slate-400 mt-1 font-medium">Police • Service Public • Actes unilatéraux • Contrats administratifs</span>
            </p>
          </div>
        </header>
